'**
'Nom de la composante : cmdUnionListeIdentifiant.vb
'
'''<summary>
...
'''</remarks>
''' 
Public Class cmdUnionSelection
    ...
    Protected Overrides Sub OnClick()
        Try
            'Appel du module qui effectue le traitement pour l'union entre les sélections d'éléments
            modBarreLayerSelection.UnionSelection(gpApp)
