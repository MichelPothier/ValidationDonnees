'**
'Nom de la composante : cmdIntersectListeIdentifiant.vb
'
'''<summary>
...
'''</remarks>
''' 
Public Class cmdIntersectSelection
    ...
    Protected Overrides Sub OnClick()
        Try
            'Appel du module qui effectue le traitement pour faire l'intersection entre les sélections d'éléments
            modBarreLayerSelection.IntersectSelection(gpApp)
