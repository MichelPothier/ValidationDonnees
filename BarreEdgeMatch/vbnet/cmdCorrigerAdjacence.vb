...
'**
'Nom de la composante : cmdCorrigerAdjacence.vb
'
'''<summary>
''' Commande qui permet de corriger les erreurs d'adjacence présentent aux points d'adjacence sur les limites communes de découpage.
'''</summary>
'''
'''<remarks>
...
'''</remarks>
''' 
Public Class cmdCorrigerAdjacence
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            'Corriger les erreurs d'adjacence
            Call CorrigerErreurAdjacence()
    ...
    Protected Overrides Sub OnUpdate()
        'Vérifier si aucune erreur d'adjacence
        If m_ErreurFeatureAdjacence Is Nothing Then
            'Désactiver la commande
            Enabled = False
        Else
            'Vérifier si aucune erreur d'adjacence
            If m_ErreurFeatureAdjacence.Count = 0 Then
                'Désactiver la commande
                Enabled = False
            Else
                'Activer la commande
